...
fn main() {
    //struct
    let line=Line{a:Point{x:0,y:0},b:Point{x:10,y:10}};
    println!("Line @:({},{}):({},{})",line.a.x,line.a.y,line.b.x,line.b.y);
    ...
    println!("elem at [0] ={}, size of the array is {}",arr[0],arr.len());
    arr[0]=3;
    ...
    println!("sum and prod of {0},{1} => {0}+{1}={2} - {0}*{1}={3}",x,y,sp.0,sp.1);
